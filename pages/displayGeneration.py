...
def seekQR(ID):
    ...
    receive_file(pathToQR, PEPPER_QR_LANDING)
...
def seekImg(ID):
    ...
    receive_file(pathToImg, PEPPER_IMG_LANDING)
...
def sendPage():
    ...
    receive_file(FILE_NAME_TEMP, PEPPER_PAGE_LANDING)
...
def generateCampusPage():
    ...
    campBodyText = "Uni isn't just about books and study - you're also here to meet new people, try new things, share knowledge and discover your hidden talents. Make the most of your time at Deakin by joining one of our clubs and societies."
    campID = "Camp"
